CREATE PROC [Finance].[RecordShareholderTransaction] ( @Account nvarchar(10) ,@fAspNetUserID nvarchar(20),@DateOfTransaction date,@Amount money,@Description nvarchar(100)) AS
