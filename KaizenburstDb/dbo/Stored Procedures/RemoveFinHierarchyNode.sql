CREATE PROC [dbo].[RemoveFinHierarchyNode](@Node hierarchyID)   
AS   
BEGIN  
   ...
   --   FROM [dbo].[FinancialHierarchy]   
   --   WHERE FinHierarchyID.GetAncestor(1) =@ParentCatNode ;  

   --   INSERT [dbo].[FinancialHierarchy]  ([FinHierarchyID], [ShortName], [Description],[Card])  
